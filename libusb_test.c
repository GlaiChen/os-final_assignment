...
// For a list of vendor & product ids visit: www.linux-usb.org/usb.ids
  ...
  m_handle = libusb_open_device_with_vid_pid(NULL, (uint16_t) 0x13fe, (uint16_t) 0x1f00);
52
  ...
  libusb_get_bus_number(m_device), libusb_get_port_number(m_device), libusb_get_device_address(m_device));
